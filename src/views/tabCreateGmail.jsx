  ...
  onValidatePassword(e){
    if(e.target.value.length < 8 ){
      this.showNotification(
        ...
        " Vui lòng thêm "+ `${8 - e.target.value.length}`+" ký tự nữa." )
      this.props.dispatch({
          type: "PASSWORD",
          ...
          >	
            <Col span={4.8}>
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                <Checkbox
                  checked={this.props.setting.notSecureChecked}
                ...
                <Checkbox
                  checked={this.props.setting.openImapPOP3Checked}
            ...
            <Col span={4.8}>
              <div style={{ display: "flex", flexDirection: "column" }}>
                <Checkbox 
                    checked={this.props.setting.saveProfileChecked}
                    onChange={this.onChangeSaveProfile.bind(this)}
                >
                  Lưu Profile
                </Checkbox>
                <Checkbox
                  checked={this.props.setting.deletePhoneChecked}
                  onChange={this.onChangeDeletePhone.bind(this)}
                  style={{ marginTop: "9px", marginLeft: "0px" }}
                >
                  Xóa số điện thoại
                </Checkbox>
            ...
            <Col span={4.8}>
              <div style={{ display: "flex", flexDirection: "column" }}>
                <Checkbox 
                  onChange={this.onChangPasswordDefaultChecked.bind(this)}
                  checked={this.props.setting.passwordDefaultChecked}
                >
                  Mật khẩu cố định
                </Checkbox>
                <Input 
                  ...
                  disabled={!this.props.setting.passwordDefaultChecked}
